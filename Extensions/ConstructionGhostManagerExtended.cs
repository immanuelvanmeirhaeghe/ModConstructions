...
namespace ModConstructions.Extensions
{
    class ConstructionGhostManagerExtended : ConstructionGhostManager
    {
        ...
        {
            if (ModConstructions.IsModEnabled && ModConstructions.InstantBuildEnabled && Input.GetKeyDown(KeyCode.F8))
            {
        ...
        {
            if (ModConstructions.IsModEnabled && ModConstructions.InstantBuildEnabled)
            {
